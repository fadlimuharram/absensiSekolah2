...
<html>
    ...
    @if(isset($current_page) && ($current_page=='guru' || $current_page=='jadwalguru' || $current_page=='absensi' || $current_page=='users' || $current_page=='rekap'))
